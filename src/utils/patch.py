...
def apply_config_patches(config_path: Path, disabled=None, enabled=None):
    ...
    - disabled: Liste von Features (z. B. CONFIG_TC), die auf "# CONFIG_X is not set" gesetzt werden
    - enabled: Liste von Features (z. B. CONFIG_STATIC), die auf "CONFIG_X=y" gesetzt werden
    """
    ...
    print(f"[*] Patches angewendet auf {config_path}")
